      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          <div className="h-56 overflow-hidden rounded-lg">
            <img
              src="/src/assets/gallary-img/2025-06-19 (1).jpg.jpeg"
              alt="Gallery"
          ...
          <div className="h-56 overflow-hidden rounded-lg">
            <img
              src="/src/assets/gallary-img/2025-06-19 (2).jpg.jpeg"
              alt="Gallery"
              className="w-full h-full object-cover"
            />
          </div>
          ...
          <div className="h-56 overflow-hidden rounded-lg">
            <img
              src="/src/assets/gallary-img/2025-07-07 (1).jpg.jpeg"
              alt="Gallery"
              className="w-full h-full object-cover"
            />
          </div>
          ...
          <div className="h-56 overflow-hidden rounded-lg">
            <img
              src="/src/assets/gallary-img/2025-07-07 (2).jpg.jpeg"
              alt="Gallery"
              className="w-full h-full object-cover"
            />
          </div>
          ...
          <div className="h-56 overflow-hidden rounded-lg">
            <img
              src="/src/assets/gallary-img/2025-07-07 (3).jpg.jpeg"
              alt="Gallery"
              className="w-full h-full object-cover"
            />
          </div>
          ...
          <div className="h-56 overflow-hidden rounded-lg">
            <img
              src="/src/assets/gallary-img/2025-08-26 (1).jpg.jpeg"
              alt="Gallery"
              className="w-full h-full object-cover"
            />
          </div>
          ...
          <div className="h-56 overflow-hidden rounded-lg">
            <img
              src="/src/assets/gallary-img/2025-08-26 (2).jpg.jpeg"
              alt="Gallery"
              className="w-full h-full object-cover"
            />
          </div>
          ...
          <div className="h-56 overflow-hidden rounded-lg">
            <img
              src="/src/assets/gallary-img/2025-08-26 (3).jpg.jpeg"
              alt="Gallery"
              className="w-full h-full object-cover"
            />
          </div>
          ...
          <div className="h-56 overflow-hidden rounded-lg">
            <img
              src="/src/assets/gallary-img/2025-08-26 (4).jpg.jpeg"
              alt="Gallery"
              className="w-full h-full object-cover"
            />
          </div>
          ...
          <div className="h-56 overflow-hidden rounded-lg">
            <img
              src="/src/assets/gallary-img/2025-08-26.jpg.jpeg"
              alt="Gallery"
              className="w-full h-full object-cover"
            />
          </div>
        ...
        {selectedImage && (
          ...
          >
            <img
              src={selectedImage}
              alt="Zoomed"
              className="w-auto max-w-[95vw] max-h-[95vh] rounded-xl shadow-2xl object-contain"
              onClick={() => setSelectedImage(null)}
            />
          </div>
        )}
